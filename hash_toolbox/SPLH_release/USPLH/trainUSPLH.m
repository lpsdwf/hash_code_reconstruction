...
c_num=1000; %%% this parameter is for the number of pseduo pair-wise labels
...
for i_bit=2:nbits
    ...
    constraint_cov=USPLHparam.eta*constraint_cov+sub_cov;

    
    [eigvector, eigvalue, elapse] = PCA2(covdata+USPLHparam.eta*constraint_cov, options);
